...
TRL_ENV = {
    ...
    "FINETUNING_MODE", "OPTIMIZER", "LEARNING_RATE", "MAX_STEPS",
    "MAX_LENGTH", "GRADIENT_ACCUMULATION_STEPS", "DISTRIBUTED_BACKEND",
    "FSDP2", "DEEPSPEED_CONFIG", "STAGE", "TRAIN_SAMPLES", "EVAL_SAMPLES", "SEED",
}
MEGATRON_ENV = {
    "MODEL_ID", "MODEL_REVISION", "DATASET_ID", "DATASET_REVISION",
    "FINETUNING_MODE", "CHECKPOINT_MODE", "RECOMPUTE", "MAX_STEPS",
    "SCHEDULE_STEPS", "EVAL_ITERS", "MAX_LENGTH", "GLOBAL_BATCH_SIZE",
