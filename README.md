...
| 공개·합성 코드 문제로 execution feedback cycle을 돌리려면? | [Execution Feedback](docs/execution-feedback.md) |
...
추가로 공개·합성 Python 코드 문제에서 한 번의 execution-filtered SFT/DPO cycle을 검증하는 독립 실험 경로를 제공합니다.
