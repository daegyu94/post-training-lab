...
공통 schema, revision·manifest, 정제와 split 기준은 [main의 Dataset Guides](https://github.com/daegyu94/post-training-lab/blob/main/README.md#dataset-guides)에서 관리합니다.
이 문서의 명령은 `megatron` 브랜치의 저장소 루트에서 실행합니다.

## Public Datasets

[공개 데이터 기준](https://github.com/daegyu94/post-training-lab/blob/main/docs/datasets/public-datasets.md)을 적용한 뒤 아래 명령으로 준비합니다.
...
[사내 데이터 기준](https://github.com/daegyu94/post-training-lab/blob/main/docs/datasets/internal-data-guide.md)에 따라 검수한 trace를 변환합니다.
