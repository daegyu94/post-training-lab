...
통합 전 30B 결과는 [TRL 기록](../trl-20260908/README.md)과 [Megatron 기록](../../backends/megatron.md)에 보존하며 이번 결과와 구분합니다.
...
ARM64 Transformer Engine wheel과 userspace library 설정은 [Spark backend 가이드](../../backends/megatron.md)를 따릅니다.
