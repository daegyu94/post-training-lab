...
공통 장비 소개는 [main의 PoC Setups](https://github.com/daegyu94/post-training-lab/blob/main/README.md#poc-setups)를 참고하세요.
...
실행 결과와 해석은 [2026-09-08 Spark 실습 기록](results/spark-20260908.md)을 참고하세요.
